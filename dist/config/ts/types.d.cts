 ...
 */
type CognitoServiceConfiguration = BaseCognitoServiceConfiguration & (NoCognitoIdentityPool | CognitoIdentityPool);
/**
 * Configuration that applies to all Cognito configuration.
 */
interface BaseCognitoServiceConfiguration {
    /**
 ...
 */
interface NoCognitoIdentityPool {
    /**
...
interface CognitoIdentityPoolConfiguration {
    /**
 ...
 */
interface CognitoIdentitySocialFederation {
 ...
 */
interface CognitoUserPoolConfiguration {
    /**
...
type CognitoAutoVerifiedAttributesConfiguration = Array<CognitoAutoVerifyEmailConfiguration | CognitoAutoVerifyPhoneNumberConfiguration>;
interface CognitoAutoVerifyPhoneNumberConfiguration {
    type: 'PHONE_NUMBER';
    verificationMessage?: string;
}
interface CognitoAutoVerifyEmailConfiguration {
    type: 'EMAIL';
    verificationMessage?: string;
 ...
 */
interface CognitoOAuthConfiguration {
    /**
 ...
 * Defines a Cognito oAuth social provider
 */
type CognitoSocialProviderConfiguration = SocialProviderConfig | SignInWithAppleSocialProviderConfig;
interface CognitoPasswordPolicy {
    minimumLength?: number;
    additionalConstraints?: CognitoPasswordConstraint[];
}
type CognitoMFAConfiguration = CognitoMFAOff | CognitoMFASettings;
/**
 * Specifies that MFA should not be enabled for the user pool.
 */
interface CognitoMFAOff {
    mode: 'OFF';
}
/**
 * Specifies that MFA is enabled for the user pool.
 */
interface CognitoMFASettings {
    /**
 ...
 */
interface CognitoUserPoolGroup {
    /**
 ...
 */
declare enum CognitoPasswordConstraint {
    REQUIRE_LOWERCASE = "REQUIRE_LOWERCASE",
    REQUIRE_UPPERCASE = "REQUIRE_UPPERCASE",
    REQUIRE_DIGIT = "REQUIRE_DIGIT",
    REQUIRE_SYMBOL = "REQUIRE_SYMBOL"
}
declare enum CognitoUserPoolSigninMethod {
    USERNAME = "USERNAME",
    EMAIL = "EMAIL",
    PHONE_NUMBER = "PHONE_NUMBER",
    EMAIL_AND_PHONE_NUMBER = "EMAIL_AND_PHONE_NUMBER"
}
declare enum CognitoUserAliasAttributes {
    PREFERRED_USERNAME = "PREFERRED_USERNAME",
    EMAIL = "EMAIL",
    PHONE_NUMBER = "PHONE_NUMBER"
}
declare enum CognitoUserProperty {
    ADDRESS = "ADDRESS",
    BIRTHDATE = "BIRTHDATE",
    EMAIL = "EMAIL",
 ...
 */
declare enum CognitoUserPropertyVerified {
    EMAIL_VERIFIED = "EMAIL_VERIFIED",
    PHONE_NUMBER_VERIFIED = "PHONE_NUMBER_VERIFIED"
}

export { type AddAuthRequest, type BaseCognitoServiceConfiguration, type CognitoAdminQueries, type CognitoAutoVerifiedAttributesConfiguration, type CognitoAutoVerifyEmailConfiguration, type CognitoAutoVerifyPhoneNumberConfiguration, type CognitoIdentityPool, type CognitoIdentityPoolConfiguration, type CognitoIdentitySocialFederation, type CognitoMFAConfiguration, type CognitoMFAOff, type CognitoMFASettings, type CognitoOAuthConfiguration, CognitoPasswordConstraint, type CognitoPasswordPolicy, type CognitoServiceConfiguration, type CognitoSocialProviderConfiguration, CognitoUserAliasAttributes, type CognitoUserPoolConfiguration, type CognitoUserPoolGroup, CognitoUserPoolSigninMethod, CognitoUserProperty, CognitoUserPropertyVerified, type NoCognitoIdentityPool };
